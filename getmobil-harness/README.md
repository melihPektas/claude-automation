...
- 🔺 **Test Piramidi görselleştirmesi** — Unit (101) › Integration (79) › E2E (70), dashboard'da canlı + sağlık göstergesi
...
|--------|------|------|--------|
| 🟩 **Unit** (taban) | 101 | node:test | Saf mantık: summary, config, k6, quality (izole, ms'ler içinde) |
| 🟦 **Integration** (orta) | 79 | node:test | Modüller birlikte + gerçek dosya/subprocess I/O pipeline'ı |
| 🟧 **E2E** (tepe) | 70 | Playwright × 5 motor | Tam tarayıcıda gerçek getmobil.com akışları |

Dashboard'daki **Test Piramidi** görseli bu katmanları canlı gösterir ve `unit > integration > e2e` koşulunu ("✓ Piramit korunuyor") doğrular. Toplam **250** harness+e2e testi.
